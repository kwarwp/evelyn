...
'''},
{'date': 'Tue Aug 28 2018 16:27:28.75 GMt-0300 (-03) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
'''},
{'date': 'Wed Aug 29 2018 09:32:36.851 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''
 module <string> line 26
  def __init__(self):
  ^
IndentationError: expected an indented block
'''},
{'date': 'Sun Oct 06 2019 13:43:34.227 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''
 module <string> line 26
  def __init__(self):
  ^
IndentationError: expected an indented block
'''},
{'date': 'Sun Oct 06 2019 13:43:57.928 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''
 module <string> line 26
  def  Tesouro():
  ^
IndentationError: expected an indented block
'''},
{'date': 'Sun Oct 06 2019 13:44:27.57 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''
...
IndentationError: expected an indented block
'''},
{'date': 'Sun Oct 06 2019 13:44:59.667 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
  ...
  module <module> line 33
    templotras3.vai()
NameError: name 'templotras3' is not defined
'''},